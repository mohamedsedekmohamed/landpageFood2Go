            ...
            {navLinks.map((link, i) => {
              if (link.subLinks) {
                ...
                return (
                  ...
                  >
                    <button
                      className={`relative md:text-[12px] lg:text-[14px] xl:text-[20px] font-normal flex group px-1 py-2  ${isActive?"text-white":"text-one"}  items-center`}
                    >
{link.name === "Solutions" || link.name === "Pricing" ? (
  <>
   <span>{link.name} </span>  <i><GoArrowDownRight /></i>
  </>
) : (
  link.name
)}
