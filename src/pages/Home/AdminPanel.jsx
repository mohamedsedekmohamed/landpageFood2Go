  ...
  return (
   ...
   <div className="flex   flex-wrap md:flex-nowrap justify-center gap-2 mt-6" data-aos="zoom-in-up">
              ...
              >
                ...
                <a
                  href="https://admin.food2go.online/"
                  target="_blank"
      ...
      <div className="max-w-screen">
        ...
        <div className="flex justify-evenly py-10  gap-5 flex-wrap">
          <div
            data-aos="flip-left"
            className="flex flex-col w-[310px] h-[380px] items-center justify-center bg-two p-5 gap-5"
          >
            <svg
              width="121"
              height="120"
            ...
            <span className="font-normal text-[20px]  text-ltext-seven w-full">
              Create and organize food categories freely{" "}
            </span>
          </div>
          <div
            data-aos="flip-left"
          ...
          >
            ...
            >
              <path
                d="M105.5 75C105.5 51.875 87.965 32.795 65.5 30.295V20H55.5V30.295C33.035 32.795 15.5 51.875 15.5 75V85H105.5V75ZM25.5 75C25.5 55.705 41.205 40 60.5 40C79.795 40 95.5 55.705 95.5 75H25.5ZM10.5 90H110.5V100H10.5V90Z"
                fill="url(#paint0_linear_3041_786)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_3041_786"
                  x1="60.5"
                  y1="20"
                  x2="60.5"
                  y2="100"
          ...
          >
            ...
            <span className="font-normal text-[20px]  text-ltext-seven w-full">
              {" "}
              View, manage, and update order status instantly.{" "}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-screen">
        <div className="w-full p-10 flex flex-col items-center gap-5">
          ...
          <span className="font-normal text-[24px] text-seven w-full    text-center px-2 md:w-[90%]">
            The Admin Panel is your restaurant’s control center. Here’s what you
        ...
        <div className="flex justify-evenly py-10  gap-5 flex-wrap">
          ...
          >
            ...
            >
              <path
                d="M49.0739 93.6343L77.2224 65.4857M105.474 72.5314C105.474 29.6057 67.5624 9.73714 49.7081 5.09143C56.3939 21.8057 56.0253 34.1743 47.3939 49.4143C47.064 49.98 46.6034 50.4584 46.0507 50.8094C45.4979 51.1604 44.869 51.3739 44.2168 51.4318C43.5645 51.4897 42.9079 51.3904 42.3019 51.1423C41.6959 50.8942 41.1582 50.5044 40.7339 50.0057L29.7624 37.56C1.04815 68.0571 17.5739 117.111 63.0281 114.831C97.8024 112.689 105.474 89.5286 105.474 72.5314Z"
                stroke="url(#paint0_linear_3041_424)"
                stroke-width="5"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M52.4856 69.5828C51.9173 69.5828 51.3723 69.3571 50.9704 68.9552C50.5685 68.5533 50.3428 68.0083 50.3428 67.44C50.3428 66.8717 50.5685 66.3266 50.9704 65.9247C51.3723 65.5229 51.9173 65.2971 52.4856 65.2971M52.4856 69.5828C53.054 69.5828 53.599 69.3571 54.0009 68.9552C54.4027 68.5533 54.6285 68.0083 54.6285 67.44C54.6285 66.8717 54.4027 66.3266 54.0009 65.9247C53.599 65.5229 53.054 65.2971 52.4856 65.2971M75.2771 93.8314C74.7087 93.8314 74.1637 93.6056 73.7618 93.2038C73.36 92.8019 73.1342 92.2569 73.1342 91.6885C73.1342 91.1202 73.36 90.5752 73.7618 90.1733C74.1637 89.7715 74.7087 89.5457 75.2771 89.5457M75.2771 93.8314C75.8454 93.8314 76.3904 93.6056 76.7923 93.2038C77.1942 92.8019 77.4199 92.2569 77.4199 91.6885C77.4199 91.1202 77.1942 90.5752 76.7923 90.1733C76.3904 89.7715 75.8454 89.5457 75.2771 89.5457"
                stroke="url(#paint1_linear_3041_424)"
                stroke-width="5"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
          ...
          >
            ...
            >
              <path
                d="M105.5 63.75V82.5H15.5V22.5H53V15H15.5C13.5109 15 11.6032 15.7902 10.1967 17.1967C8.79018 18.6032 8 20.5109 8 22.5V82.5C8 84.4891 8.79018 86.3968 10.1967 87.8033C11.6032 89.2098 13.5109 90 15.5 90H45.5V105H30.5V112.5H90.5V105H75.5V90H105.5C107.489 90 109.397 89.2098 110.803 87.8033C112.21 86.3968 113 84.4891 113 82.5V63.75H105.5ZM68 105H53V90H68V105Z"
                fill="url(#paint0_linear_3041_613)"
              />
              <path
                d="M113 37.5V30H105.121C104.635 27.6535 103.703 25.4219 102.376 23.4263L107.964 17.8387L102.661 12.5362L97.0737 18.1238C95.0781 16.7971 92.8465 15.8652 90.5 15.3787V7.5H83V15.3787C80.6535 15.8652 78.4219 16.7971 76.4262 18.1238L70.8387 12.5362L65.5363 17.8387L71.1238 23.4263C69.7971 25.4219 68.8652 27.6535 68.3787 30H60.5V37.5H68.3787C68.8652 39.8465 69.7971 42.0781 71.1238 44.0737L65.5363 49.6613L70.8387 54.9637L76.4262 49.3763C78.4219 50.7029 80.6535 51.6348 83 52.1213V60H90.5V52.1213C92.8465 51.6348 95.0781 50.7029 97.0737 49.3763L102.661 54.9637L107.964 49.6613L102.376 44.0737C103.703 42.0781 104.635 39.8465 105.121 37.5H113ZM86.75 45C84.525 45 82.3499 44.3402 80.4998 43.104C78.6498 41.8679 77.2078 40.1109 76.3564 38.0552C75.5049 35.9995 75.2821 33.7375 75.7162 31.5552C76.1502 29.3729 77.2217 27.3684 78.795 25.795C80.3684 24.2217 82.3729 23.1503 84.5552 22.7162C86.7375 22.2821 88.9995 22.5049 91.0552 23.3564C93.1109 24.2078 94.8679 25.6498 96.104 27.4998C97.3402 29.3499 98 31.525 98 33.75C97.997 36.7328 96.8108 39.5925 94.7017 41.7017C92.5925 43.8108 89.7328 44.997 86.75 45Z"
                fill="url(#paint1_linear_3041_613)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_3041_613"
                  x1="60.5"
                  y1="15"
                  x2="60.5"
                  y2="112.5"
          ...
          >
            ...
            <span className="font-normal text-[20px]  text-ltext-seven w-full">
              Enjoy powerful tools and constant updates{" "}
            </span>
          </div>
        </div>
      </div>
