    ...
    <div id="MenuScan">
        ...
        <div className="w-[90%] mx-auto  flex flex-col md:flex-row gap-6  h-fit py-10  px-6 lg:px-20 bg-two">
          <div className="flex flex-col  gap-10 flex-1 py-10 w-full md:w-1/2 ">
            <span className="font-normal text-3xl sm:text-4xl judson-regular lg:text-5xl text-black">
              Transform your paper menu into a smart experience in seconds!{" "}
            </span>
            <p className="font-normal  open-sans-regular text-base sm:text-lg lg:text-[20px] text-seven">
              Scan the QR, browse the menu, and order easily without touching
              anything. Menu Scan service makes your customers' experience
              faster, cleaner, and more modern – all without the hassle.
            </p>

            <div
              className="flex   flex-wrap md:flex-nowrap justify-center gap-2 mt-6"
              data-aos="zoom-in-up"
            >
              <a
                href="https://my.food2go.online/signUp"
                className="text-base flex justify-center items-center gap-3 open-sans-regular  w-full sm:w-[200px] lg:w-[296px] h-[60px] lg:h-[72px] bg-one rounded-3xl text-white transition hover:bg-gradient-to-b from-six to-one hover:scale-95"
              >
                <span>Try the service now </span>
                <MdArrowOutward />
              </a>
              <a
                href="https://orderfood.food2go.online/table/"
                target="_blank"
      ...
      <div className="max-w-screen">
        <div className="w-full p-10 flex flex-col gap-5">
          <span className="w-full text-left font-semibold  text-[30px] lg:text-[40px] text-seven">
            Why Choose Menu Scan?
          </span>
          <span className="font-normal text-[24px] text-seven w-full px-2 md:w-[50%]">
            Switch to a smart digital menu that saves you time and effort, while
            offering your customers a seamless and modern experience. Easy
            updates, no printing costs — all in seconds.
          </span>
        </div>
        ...
        <div className="flex justify-evenly py-10  flex-wrap gap-5">
          <div
            data-aos="flip-left"
            className="flex flex-col w-[300px] h-[380px] items-center justify-center bg-two p-5 gap-5"
          >
            <svg
              width="121"
              height="120"
            ...
            <span className="font-normal text-[20px] text-seven">
              Fast browsing and instant ordering without delays
            </span>
          </div>
          <div
            data-aos="flip-left"
          ...
          >
            ...
            <span className="font-normal text-[20px] text-seven">
              Sleek interface compatible with all devices.
            </span>
          </div>
          <div
            data-aos="flip-left"
          ...
          >
            ...
            <span className="font-normal text-[20px] text-seven">
              {" "}
              Say goodbye to printing and manual update costs
            </span>
          </div>
          <div
            data-aos="flip-left"
          ...
          >
            ...
            <span className="font-normal text-[20px] text-seven">
              {" "}
              Instantly update prices and content
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-screen">
        <div className="w-full p-10 flex flex-col gap-5">
          <span className="w-full text-left font-semibold  text-[30px] lg:text-[40px] text-seven">
            How Does the Menu Scan Service Work?
          </span>
          <span className="font-normal text-[24px] text-seven w-full px-2 md:w-[50%]">
            We offer a smart and seamless way to display your digital menu. Just
            scan, browse, and order — everything at your customers’ fingertips.
          </span>
        </div>
        ...
        <div className="flex justify-evenly py-10  flex-wrap gap-5">
          ...
          >
            ...
            <span className="font-normal text-[20px] text-seven">
              Scan the code to access the digital menu instantly.
            </span>
          </div>
          <div
            data-aos="flip-left"
          ...
          >
            ...
            <span className="font-normal text-[20px] text-seven">
              Browse the menu smoothly — no app needed.
            </span>
          </div>
          <div
            data-aos="flip-left"
          ...
          >
            ...
            <span className="font-normal text-[20px] text-seven">
              Get the app for full access & better experience (optional).
            </span>
          </div>
        </div>
      </div>
